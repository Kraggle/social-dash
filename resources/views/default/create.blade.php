                ...
                <form method="post" enctype="multipart/form-data" action="{{ route('default.store') }}" autocomplete="off">
                            ...
                            <div class="row justify-content-md-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Some Name') }}" value="{{ old('name') }}" required="true" aria-required="true" />
                            ...
                            <div class="row justify-content-md-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                        <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="input-description" type="description" placeholder="{{ __('A nice description about what the variable is for!') }}" >{{ old('description') }}</textarea>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group{{ $errors->has('for_table') ? ' has-danger' : '' }}">
                                        <select class="selectpicker" data-size="7" data-style="btn btn-primary" id="input-for-table" name="for_table">
                                            <option value="accounts"{{ !old('for_table') || old('for_table') == 'accounts' ? ' selected' : ''}}>Accounts</option>
                                            <option value="posts"{{ old('for_table') == 'posts' ? ' selected' : ''}}>Posts</option>
                                            <option value="teams"{{ old('for_table') == 'teams' ? ' selected' : ''}}>Teams</option>
                                            <option value="users"{{ old('for_table') == 'users' ? ' selected' : ''}}>Users</option>
                                        </select>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            ...
                            @php $type = old('type') ?? 'number'; @endphp
                            ...
                            <div class="row justify-content-md-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group{{ $errors->has('key') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('key') ? ' is-invalid' : '' }}" name="key" id="input-key" type="text" placeholder="{{ __('some_key') }}" />
                                    </div>
                                        ...
                                        <div class="row" repeat="_0">
                                            ...
                                            <div class="col-sm-6 pr-0">
                                                <div class="form-group">
                                                    <input class="form-control" name="value_0" id="text-value-1" type="text" value="{{ old('value_0') }}" placeholder="{{ __('Some Value')}}" {{ $disabled }} />
                                                </div>
                                            </div>
                                            <div class="col-sm-4 pr-0">
                                                 <div class="input-group">
                                                    ...
                                                    <input class="form-control" name="cost_0" type="number" step=".01" min="0" placeholder="25.00" value="{{ old('cost_0') }}" {{ $disabled }} />
                                                </div>
                                            </div>
                                            <div class="col-sm-2 pr-0">
                                ...
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has('default') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('default') ? ' is-invalid' : '' }}" name="default" id="number-default" type="number" value="{{ old('default') }}" {{ $disabled }} />
                                        </div>
                                ...
                                <div class="row justify-content-md-center{{ $type == 'number' ? '' : ' d-none'}}">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has('min_value') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('min-value') ? ' is-invalid' : '' }}" name="min_value" id="input-min_value" type="number" value="{{ old('min_value') }}" placeholder="1000" {{ $disabled }} />
                                        </div>
                                ...
                                <div class="row justify-content-md-center{{ $type == 'number' ? '' : ' d-none'}}">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has('max_value') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('max_value') ? ' is-invalid' : '' }}" name="max_value" id="input-max-value" type="number" value="{{ old('max_value') }}" placeholder="60000" {{ $disabled }} />
                                        </div>
                                ...
                                <div class="row justify-content-md-center{{ $type == 'number' ? '' : ' d-none'}}">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has('step') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('step') ? ' is-invalid' : '' }}" name="step" id="input-step" type="number" value="{{ old('step') }}" placeholder="1000" min="1" {{ $disabled }} />
                                        </div>
                                ...
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group{{ $errors->has('min_cost') ? ' has-danger' : '' }}">
                                            ...
                                            <input class="form-control{{ $errors->has('min_cost') ? ' is-invalid' : '' }}" name="min_cost" id="number-min-cost" type="number" value="{{ old('min_cost') }}" placeholder="0.00" step=".01" min="0" {{ $disabled }} />
                                        </div>
                                ...
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group{{ $errors->has('max_cost') ? ' has-danger' : '' }}">
                                            ...
                                            <input class="form-control{{ $errors->has('max_cost') ? ' is-invalid' : '' }}" name="max_cost" id="number-max-cost" type="number" value="{{ old('max_cost') }}" placeholder="100.00" step=".01" min="0" {{ $disabled }} />
                                        </div>
                                ...
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group{{ $errors->has('on_cost') ? ' has-danger' : '' }}">
                                            ...
                                            <input class="form-control{{ $errors->has('on_cost') ? ' is-invalid' : '' }}" name="on_cost" id="boolean-on-cost" type="number" value="{{ old('on_cost') }}" placeholder="50.00" step=".01" min="0" {{ $disabled }} />
                                        </div>
                                ...
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group{{ $errors->has('off_cost') ? ' has-danger' : '' }}">
                                            ...
                                            <input class="form-control{{ $errors->has('off_cost') ? ' is-invalid' : '' }}" name="off_cost" id="boolean-off-cost" type="number" value="{{ old('off_cost') }}" placeholder="0.00" step=".01" min="0" {{ $disabled }} />
                                        </div>
