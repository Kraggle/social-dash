...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <form method="post" enctype="multipart/form-data" action="{{ route('default.store') }}"
                        autocomplete="off">
                        @csrf
                        @method('post')
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has($dot) ? ' has-danger' : '' }}">
                                            <textarea class="form-control{{ $errors->has($dot) ? ' is-invalid' : '' }}"
                                                ...
                                                placeholder="{{ __('A nice description about what the variable is for!') }}">{{ old($dot) }}</textarea>
                                            @include('alerts.feedback', ['field' => $dot])
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group{{ $errors->has($dot) ? ' has-danger' : '' }}">
                                            <select class="selectpicker" data-size="7" data-style="btn btn-primary"
                                                ...
                                                <option value="accounts"
                                                    {{ !old($dot) || old($dot) == 'accounts' ? ' selected' : '' }}>
                                                    Accounts</option>
                                                <option value="posts" {{ old($dot) == 'posts' ? ' selected' : '' }}>Posts
                                                </option>
                                                <option value="teams" {{ old($dot) == 'teams' ? ' selected' : '' }}>Teams
                                                </option>
                                                <option value="users" {{ old($dot) == 'users' ? ' selected' : '' }}>Users
                                                </option>
                                            </select>
                                            @include('alerts.feedback', ['field' => $dot])
                                        </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has($dot) ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has($dot) ? ' is-invalid' : '' }}"
                                                ...
                                                placeholder="{{ __('some_key') }}" value="{{ old($dot) }}" />
                                            @include('alerts.feedback', ['field' => $dot])
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-sm-2 pr-0 has-switch">
                                                    <div class="form-group">
                                                        <input class="bootstrap-switch" name="{{ $name }}"
                                                            ...
                                                            {{ old($dot) == 'on' ? 'checked' : '' }} data-off-label="NO"
                                                            data-on-label="YES" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <input class="form-control" name="{{ $name }}" id="number-default"
                                                    type="number" value="{{ old($dot) }}" {{ $disabled }} />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <input class="form-control" name="{{ $name }}" id="input-min-value"
                                                    type="number" value="{{ old($dot) }}" placeholder="1000"
                                                    {{ $disabled }} />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <input class="form-control" name="{{ $name }}" id="input-max-value"
                                                    type="number" value="{{ old($dot) }}" placeholder="60000"
                                                    {{ $disabled }} />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <input class="form-control" name="{{ $name }}" id="input-step"
                                                    type="number" value="{{ old($dot) }}" placeholder="1000" min="1"
                                                    {{ $disabled }} />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="{{ $name }}" id="number-min-cost"
                                                    type="number" value="{{ old($dot) }}" placeholder="0.00" step=".01"
                                                    min="0" {{ $disabled }} />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="{{ $name }}" id="number-max-cost"
                                                    type="number" value="{{ old($dot) }}" placeholder="100.00"
                                                    step=".01" min="0" {{ $disabled }} />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10 has-switch">
                                            <div class="form-group">
                                                <input class="bootstrap-switch" name="{{ $name }}"
                                                    ...
                                                    {{ old($dot) == 'on' ? 'checked' : '' }} data-off-label="OFF"
                                                    data-on-label="ON" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="{{ $name }}" id="boolean-on-cost"
                                                    type="number" value="{{ old($dot) }}" placeholder="50.00"
                                                    step=".01" min="0" {{ $disabled }} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="{{ $name }}"
                                                    id="boolean-off-cost" type="number" value="{{ old($dot) }}"
