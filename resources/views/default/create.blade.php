                  ...
                  <div class="col-sm-10">
                    <div class="form-group{{ $errors->has($dot) ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has($dot) ? ' is-invalid' : '' }}"
                        ...
                        value="{{ old($dot) }}" required="true" aria-required="true" />
                  ...
                  <div class="col-sm-10">
                    <div class="form-group{{ $errors->has($dot) ? ' has-danger' : '' }}">
                      <select class="selectpicker" data-size="7" data-style="btn btn-primary" id="input-for-table"
                        name="{{ $name }}">
                        <option value="accounts" {{ !old($dot) || old($dot) == 'accounts' ? ' selected' : '' }}>
                          Accounts</option>
                        ...
                        <div class="col-sm-6 pr-0">
                          <div class="form-group">
                            <input class="form-control" name="{{ $name }}" type="text"
                              value="{{ old($dot) }}" placeholder="{{ __('Some Value') }}" {{ $disabled }} />
                          </div>
                        </div>
                        ...
                        <div class="col-sm-3 pr-0">
                          <div class="input-group">
                            ...
                            <input class="form-control" name="{{ $name }}" type="number" step=".01" min="0"
                              placeholder="25.00" value="{{ old($dot) }}" {{ $disabled }} />
                          </div>
                        </div>
                      ...
                      @foreach (old('options.values') ?? [] as $value)
                        ...
                        <div class="row" repeat="_{{ $loop->index }}">
                          ...
                          <div class="col-sm-6 pr-0">
                            <div class="form-group">
                              <input class="form-control" name="{{ $name }}" type="text"
                                value="{{ old($dot) }}" placeholder="{{ __('Some Value') }}"
                                {{ $disabled }} />
                            </div>
                          </div>
                          ...
                          <div class="col-sm-2 pr-0 has-switch">
                            <input class="bootstrap-switch" name="{{ $name }}" type="checkbox"
                              {{ $disabled }} {{ old($dot) == 'on' ? 'checked' : '' }} data-off-label="NO"
                              data-on-label="YES" />
                          </div>
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input class="form-control" name="{{ $name }}" id="input-min-value" type="number"
                          value="{{ old($dot) }}" placeholder="1000" {{ $disabled }} />
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input class="form-control" name="{{ $name }}" id="input-max-value" type="number"
                          value="{{ old($dot) }}" placeholder="60000" {{ $disabled }} />
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input class="form-control" name="{{ $name }}" id="input-step" type="number"
                          value="{{ old($dot) }}" placeholder="1000" min="1" {{ $disabled }} />
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input class="form-control" name="{{ $name }}" id="number-min-cost" type="number"
                          value="{{ old($dot) }}" placeholder="0.00" step=".01" min="0" {{ $disabled }} />
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input class="form-control" name="{{ $name }}" id="number-max-cost" type="number"
                          value="{{ old($dot) }}" placeholder="100.00" step=".01" min="0" {{ $disabled }} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-md-center">
                    ...
                    <div class="col-sm-10 has-switch">
                      <input class="bootstrap-switch" name="{{ $name }}" id="switch-default" type="checkbox"
                        {{ $disabled }} {{ old($dot) == 'on' ? 'checked' : '' }} data-off-label="OFF"
                        data-on-label="ON" />
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input class="form-control" name="{{ $name }}" id="boolean-on-cost" type="number"
                          value="{{ old($dot) }}" placeholder="50.00" step=".01" min="0" {{ $disabled }} />
                      </div>
                    </div>
                  </div>
