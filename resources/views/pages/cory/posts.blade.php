      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="http://localhost:8000/compareposts"><button class="btn btn-warning btn-gradient float-right ml-2 mt-0">Compare</button></a>
              <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                <label class="btn btn-sm btn-warning btn-gradient btn-simple active" id="0">
                  <input type="radio" name="options" checked>
                  <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Photos</span>
                    ...
                    <table id="datatable" class="table table-striped">
                      <thead>
                        <tr>
                          ...
                          <th class="sorting_desc_disabled sorting_asc_disabled text-right" title="Enter Text Here">Actions
                          </th>
                        </tr>
                      </thead>
                      <tbody>
