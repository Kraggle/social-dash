                                ...
                                <div class="col-sm-9">
                                    <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                                        ...
                                        <label class="btn btn-sm btn-warning btn-simple" id="2">
                                            <input type="radio" class="d-none" name="options">
                                            <span
                                                class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Carousels</span>
                                            <span class="d-block d-sm-none">
                                                <i class="tim-icons icon-tap-02"></i>
                                            </span>
                                        </label>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-sm-12 text-left">
                                    {{-- <h5 class="card-category">Suck my massive meaty malfored balls</h5> --}}
                                        ...
                                        <table id="datatable" class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sorting_desc_disabled sorting_asc_disabled text-right"
                                                        title="Enter Text Here">Actions
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="photo">
                                                            <img src="{{ asset('white') }}/img/tania.jpg"
                                                                alt="Table image">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="javascript:void(0)"
                                                            class="btn btn-link btn-info btn-icon btn-sm like"><i
                                        ...
                                        <div class="card card-post">
                                            <div class="card-header">
                                                ...
                                                <label for="myCheckbox1"><img
                                                        src="http://localhost:8000/white/img/post1.jpg"></label>

                                                <ul
                                                    class="nav nav-pills nav-pills-warning nav-pills-icons justify-content-center pt-2">
                                                    <li class="nav-item">
                                                ...
                                                <div class="tab-content tab-space tab-subcategories mt-0">
                                                    <div class="tab-pane active" id="link7">
                                                        ...
                                                        <div class="row card-stats">
                                                            <div class="col-6">
                                                                <h4><a
                                                                        href="http://localhost:8000/individualpost">Likes:</a>
                                                                </h4>
                                                            </div>
                                                            <div class="col-6">
                                                                <p>132</p>
                                                        ...
                                                        <div class="row card-stats">
                                                            <div class="col-6">
                                                                <h4><a
                                                                        href="http://localhost:8000/individualpost">Comments:</a>
                                                                </h4>
                                                            </div>
                                                            <div class="col-6">
                                                                <p>31</p>
                                        ...
                                        <div class="card card-post">
                                            <div class="card-header">
                                                ...
                                                <label for="myCheckbox2"><img
                                                        src="http://localhost:8000/white/img/post2.jpg"></label>
                                        ...
                                        <div class="card card-post">
                                            <div class="card-header">
                                                ...
                                                <label for="myCheckbox3"><img
                                                        src="http://localhost:8000/white/img/post3.jpg"></label>
                                        ...
                                        <div class="card card-post">
                                            <div class="card-header">
                                                ...
                                                <label for="myCheckbox4"><img
                                                        src="http://localhost:8000/white/img/post4.jpg"></label>
                                        ...
                                        <div class="card card-post">
                                            <div class="card-header">
                                                ...
                                                <label for="myCheckbox5"><img
                                                        src="http://localhost:8000/white/img/post5.jpg"></label>
                                        ...
                                        <div class="card card-post">
                                            <div class="card-header">
                                                ...
                                                <label for="myCheckbox6"><img
                                                        src="http://localhost:8000/white/img/post6.jpg"></label>
                                    ...
                                    <div class="col-3">
                                        <div class="card card-post">
                                            <div class="card-header">
                                                ...
                                                <label for="myCheckbox7"><img
                                                        src="http://localhost:8000/white/img/post7.jpg"></label>
                                                <ul
                                                    class="nav nav-pills nav-pills-warning nav-pills-icons justify-content-center pt-2">
                                                    <li class="nav-item">
                                        ...
                                        <div class="card card-post">
                                            <div class="card-header">
                                                ...
                                                <label for="myCheckbox8"><img
                                                        src="http://localhost:8000/white/img/post8.jpg"></label>
                                                <ul
                                                    class="nav nav-pills nav-pills-warning nav-pills-icons justify-content-center pt-2">
                                                    <li class="nav-item">
