@extends('layouts.app', ['activePage' => 'notifications', 'menuParent' => 'components', 'titlePage' =>
__('Notifications')])
                          ...
                          <div class="row">
                            <div class="col-md-8">
                              ...
                              <p class="description">The first step is to create an account at
                                <a href="javascript:void(0)">Creative Tim</a>. You can choose a social network or go for
