      ...
      <div class="row">
        <div class="col-3 card" style="margin-bottom: 15px">
          <div class="card" style="margin-bottom: 0px">
            <button class="btn btn-warning btn-gradient float-right ml-4 mr-4 mt-4">+ Another Post</button>
          </div>
        </div>
        <div class="col-2 card" style="margin-bottom: -15px">
          <div class="card" style="margin-bottom: 0px">
            <button class="btn btn-warning btn-gradient float-right mt-4">Save Comparison</button>
          </div>
        </div>
        ...
        <div class="col-2 card" style="margin-bottom: -15px">
          <div class="card" style="margin-bottom: 0px">
            <button class="btn btn-warning btn-gradient float-right mt-4">Remove Post</button>
          </div>
        </div>
      </div>
      <div class="row">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-2 card text-right">
                      <div class="card">
                        <h4 title="This is the type of post you have published. It can be between a photo/carousel/video.">
                          Type</h4>
                        ...
                        <h4 title="The percentage of engagement from your followers towards your post.">
                          Eng Rate</h4>
                        <h4 title="How many different hashtags you have used on the post.">Hashtags
                        </h4>
                        <h4 title="What the overall average difficulty of the targeted hashtags is.">
                          Avg Tag Difficulty</h4>
                        <h4 title="The average amount of likes for each hashtags used.">Likes Per
                          Tag</h4>
                        <h4 title="How many additional followers were generated during this timeframe.">
                    ...
                    <div class="col-2 card text-right">
                      <div class="card">
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">Photo</a></h4>
                        ...
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">05/02/2021</a>
                        </h4>
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">11:04</a></h4>
                        <div class="card">
                          <a href="http://localhost:8000/individualpost"><button class="btn btn-warning btn-gradient float-right ml-4 mr-4 mt-3">View
                              Post</button></a>
                        </div>
                      </div>
                    </div>
                    <div class="col-2 card">
                      <div class="card">
                        ...
                        <h4 class="col-12" style="color: red; text-align: center;">32</h4>
                        <h4 class="col-12" style="color: red; text-align: center;">12</h4>
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">21/04/2020</a>
                        </h4>
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">09:58</a></h4>
                        <a href="http://localhost:8000/individualpost"><button class="btn btn-warning btn-gradient float-right ml-4 mr-4 mt-3">View
                            Post</button></a>
                      </div>
                    </div>
                    <div class="col-2 card">
                      <div class="card">
                        ...
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">15/08/2020</a>
                        </h4>
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">13:01</a></h4>
                        <a href="http://localhost:8000/individualpost"><button class="btn btn-warning btn-gradient float-right ml-4 mr-4 mt-3">View
                            Post</button></a>
                      </div>
                    </div>
                    <div class="col-2 card">
                      <div class="card">
                        ...
                        <h4 class="col-12" style="color: red; text-align: center;">18</h4>
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">09/11/2020</a>
                        </h4>
                        <h4 class="col-12" style="text-align: center;"><a href="http://localhost:8000/posts">18:13</a></h4>
                        <a href="http://localhost:8000/individualpost"><button class="btn btn-warning btn-gradient float-right ml-4 mr-4 mt-3">View
                            Post</button></a>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-2">
                      <div class="progress-container progress-warning">
                        <span class="progress-badge"><a href="http://localhost:8000/hashtags">#moneymotivation</a></span>
                        <div class="progress">
                      ...
                      <div class="progress-container progress-warning">
                        <span class="progress-badge"><a href="http://localhost:8000/hashtags">#millionairemotivation</a></span>
                        <div class="progress">
                      ...
                      <div class="progress-container progress-warning">
                        <span class="progress-badge"><a href="http://localhost:8000/hashtags">#entrepreneurmotivation</a></span>
                        <div class="progress">
                      ...
                      <div class="progress-container progress-warning">
                        <span class="progress-badge"><a href="http://localhost:8000/hashtags">#moneyinspiation</a></span>
                        <div class="progress">
                      ...
                      <div class="progress-container progress-warning">
                        <span class="progress-badge"><a href="http://localhost:8000/hashtags">#billionairemotivation</a></span>
                        <div class="progress">
                      ...
                      <button class="btn btn-warning btn-gradient btn-round float-right">VIEW ALL HASHTAGS</button>
                    </div>
                    <div class="col-2">
                      <div class="progress-container progress-warning">
                        <span class="progress-badge"><a href="http://localhost:8000/hashtags">#moneymotivation</a></span>
