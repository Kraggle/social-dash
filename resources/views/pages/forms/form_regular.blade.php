      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-fill btn-primary btn-gradient">Submit</button>
          </div>
        </div>
      </div>
      <div class="col-md-6">
          ...
          <div class="card-footer">
            <form class="form-horizontal">
              <div class="row">
                <label class="col-md-3 col-form-label"></label>
                <div class="col-md-9">
                  <button type="submit" class="btn btn-fill btn-primary btn-gradient">Sign in</button>
                </div>
              </div>
            </form>
          </div>
