            ...
            <div class="card card-stats">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="numbers">
                                <p class="card-category"><a style="color: #ff6b8a" href="http://localhost:8000/followers">Impressions</a></p>
...
=======
                        ...
                        <div class="col-7">
                            <div class="numbers">
                                <p class="card-category"><a style="color: #ff6b8a" href="http://localhost:8000/likes">Engagements</a></p>
            ...
            <div class="card card-stats">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="numbers">
                                <p class="card-category"><a style="color: #ff6b8a" href="http://localhost:8000/comments">Average Users Activity</a></p>
            ...
            <div class="card card-stats">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="numbers">
                                <p class="card-category"><a style="color: #ff6b8a" href="http://localhost:8000/posts">Profile Actions</a></p>
            ...
            <div class="card card-stats">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="numbers">
                                <p class="card-category"><a style="color: #ff6b8a" href="http://localhost:8000/followers">Followers</a></p>
            ...
            <div class="card card-stats">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="numbers">
                                <p class="card-category"><a style="color: #ff6b8a" href="http://localhost:8000/comments">Comments</a></p>
