                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10 mt-2">
                                    <input type="checkbox" name="show_on_homepage" value="1" {{ old('show_on_homepage') == 1 ? ' checked' : '' }} class="bootstrap-switch" data-on-label="Yes" data-off-label="No" />
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('date') ? ' has-danger' : '' }}">
                                        <input type="text" name="date" id="date" placeholder="{{ __('Select date') }}" class="form-control datetimepicker" value="{{ old('date', now()->format('d-m-Y')) }}" />
